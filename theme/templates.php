...
<head>
    ...
    <title>Home | APRIL AND MARC FROZEN MEAT TRADING</title>
...
<body style="background-color:white" onload="totalprice()" >
  ...
  <header id="header"><!--header-->
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/smol.png" alt="" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>April and Marc</span> Frozen Meat Trading</h2>
              <p>" Let me Meat your Needs! "</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Alrights Reserved 2024 </p>
          <p class="pull-right">Capstone Project</p>
        </div>
      </div>
    </div>
